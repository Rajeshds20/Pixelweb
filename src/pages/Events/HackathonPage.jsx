...
import Hackathon from "./posters/hackathon.jpg"
...
function QuizPage() {
    ...
    return (
        <div className="mainbody">
            ...
            <br /><br />
            <img style={{ width: '70%', marginLeft: '15%' }} className="brochureimg" src={Hackathon} alt="brochure" />
            <div className="box1">
            ...
            <div className="box5">
                ...
                <div className='box5content'>
                    <h4>Bandi Pavan</h4>
                    <h5>Phone: 6309547963</h5>
                    <h5>Email: pavanbandi106@gmail.com</h5>
                </div>
            </div>
        </div >
    );
