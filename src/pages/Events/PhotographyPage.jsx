...
import Photography from './posters/photography.png'
...
function QuizPage() {
    ...
    return (
        <div className="mainbody">
            ...
            <br /><br />
            <img style={{ width: '70%', marginLeft: '15%' }} className="brochureimg" src={Photography} alt="brochure" />
            <div className="box1">
            ...
            <div className="box3">
                ...
                <ul color='aliceblue'>
                    ...
                    {/* Sample Rules for Photography competetion */}
                    <li><h5>Participants should submit their own photos only</h5></li>
                    <li><h5>Participants should not use any unfair means</h5></li>
                    <li><h5>Participants should not use any editing tools, filters</h5></li>
                </ul>
            </div >
            <br />
            <div className="box4">
