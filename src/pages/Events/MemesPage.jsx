...
import Memes from './posters/Memes.jpg'
...
function QuizPage() {
    ...
    return (
        <div className="mainbody">
            ...
            <br /><br />
            <img style={{ width: '70%', marginLeft: '15%' }} className="brochureimg" src={Memes} alt="brochure" />
            <div className="box1">
                <h3>About the Event</h3>
                <br />
                <h5>
                    Memes, is a competetion where the participants have to submit a meme which is made by them, based on voting and likes, the best will be selected as winner.
                </h5>
                <br />
            ...
            <div className="box5">
                ...
                <div className='box5content'>
                    <h4>G.Chiranjeevi</h4>
                    <h5>Phone: 8985760110</h5>
                    <h5>Email: gurramchiranjeevi786@gmail.com</h5>
                </div>
            </div>
        </div >
    );
